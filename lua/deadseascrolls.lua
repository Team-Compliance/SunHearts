local DSSModName = "Dead Sea Scrolls (Sun Hearts)"
    ...
    settings = {
        ...
        buttons = {
           ...
           
            {
                ...
                variable = 'ComplianceSun.optionNum',
                ...
                tooltip = {strset = {'change', 'appearance', 'of sun', 'hearts'}}
            },
            
            {
                ...
                variable = "ComplianceSun.optionChance",
                ...
                tooltip = {strset = {"sun", "heart's ", "rarity"}},
            },
...
local shdirkey = {
    Item = shdir.main, -- This is the initial item of the menu, generally you want to set it to your main item
...
ComplianceSun:AddCallback(ModCallbacks.MC_INPUT_ACTION, OverridePause, InputHook.IS_ACTION_PRESSED)
...
DeadSeaScrollsMenu.AddMenu("Sun Hearts", {
